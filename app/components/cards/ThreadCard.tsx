                    ...
                    <div className='flex w-full flex-col'>
                        ...
                        <div className='flex flex-col mt-5 gap-3'>
                            <div className='flex gap-3.5 '>
                                ...
                                <Link href={`/thread/${id}`}>
                                    <Image src={reply} alt='heart' width={24} height={24} className='cursor-pointer object-contain' />
                                </Link>
                                <Image src={repost} alt='heart' width={24} height={24} className='cursor-pointer object-contain' />
                                <Image src={share} alt='heart' width={24} height={24} className='cursor-pointer object-contain' />
                            </div>
